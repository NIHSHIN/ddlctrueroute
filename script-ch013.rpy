...
label ch13_exclusive_natsuki:
    ...
    if ch12_outcome == 3:
        ...
        if n_appeal >= 4 and n_appealS >= 1:
            ...
            n 1bk "Hmm..."
            mc "What is it?"
            n 1bc "Well, if we're going to be doing baking..."
            n "Then we should go all out, right?"
            mc "All out?"
            mc "What do you mean?"
            n 1ba "I think we should go downstairs and ask my mom for help."
            mc "Your mom knows how to bake?"
            n 4bw "She's the one who got me into baking in the first place!"
            mc "I see."
            mc "Do you think she could help us?"
            mc "Or at least give us some ideas."
            n 3bc "I'm sure of it."
            ...
            n "It can wait."
            n 1bq "What you're doing is probably more important anyway..."
            show natsuki zorder 2 at t21
            show momsuki 1e zorder 3 at f22
            mo "Nonsense!"
            mo "There's nothing in this world more important than you, Natsuki."
            mo 1c "So come on, let's hear it."
            show natsuki 1bk zorder 3 at f21
            show momsuki zorder 2 at t22
            n "Well..."
            n 1bt "I was wondering if you could help us with baking."
            n "We're doing this thing for the club and they want me to bake."
            n 1bq "The thing is, it's almost like a festival."
            n "So there's a lot to bake."
            show natsuki zorder 2 at t21
            show momsuki 1g zorder 3 at f22
            mo "Baking?"
            mo 1f "I'd be more than happy to help, Natsuki!"
            mo 1g "I've got this special recipe that's been passed down through the generations."
            mo "My mother told me the recipe, and her mother before that."
            mo 1c "It's rather special."
            ...
            mo "Yes, exactly that!"
            mo 1c "I'm glad you still remember."
            "Haruki smiles sweetly."
            mo 1a "Now, I'm going to need you to write down the recipe."
            mo "It's rather long."
            mo 1b "But I promise it will be worth it."
            show momsuki zorder 2 at t22
            ...
            mo 1b "I'm going to be telling Natsuki the recipe and while that's happening no cleaning on my part is going to be happening."
            mo 1c "If you could be a dear and clean up the room just for a couple of minutes."
            show natsuki 1bo zorder 3 at f21
            show momsuki zorder 2 at t22
            n "Mom!"
            n 1br "You're not seriously asking [player] to do that, are you?"
            n "It seems kinda--"
            show natsuki zorder 2 at t21
            ...
            mo 1c "Don't worry, I'm just messing around."
            mo "You should see your faces."
            mo "Anyway, I'll get you something to clean with."
            mo 1b "Natsuki, why don't you get that paper now?"
            ...
            mo 1c "And now it's just the two of us."
            "Something about the way she said that gives me a bad feeling."
            ...
            mo 1c "Here, take this."
            "Haruki gives me the broom."
            mo 1f "There's so much rubbish everywhere, you wouldn't believe it."
            mo 1g "Could you be a dear and just round up all the dust and dirt around the room?"
            mc "Yeah, no problem."
            mo 1h "I can't believe the house got this messy while I was away."
            mc "Well, it's not your fault."
            mo 1g "Oh, I don't know."
            "Haruki looks over my shoulder."
            mo "Whose fault do you think it is?"
            mc "There's only one person I can think of..."
            mo 1e "Yasuhiro, right?"
            mo "I can't blame him for everything."
            mo 1h "After all, I was the one who chose to leave."
            mo "The blame is shared."
            mc "Yeah, but--"
            mo 1c "Let's just focus on cleaning."
            mo "Talking about this won't help anyone."
            mc "I guess not..."
            mo 1a "So..."
            mo "Are you and Natsuki..."
            mo "...you know?"
            mc "W-What?"
            mc "N-No, of course not!"
            mo 1b "You don't need to lie to me."
            mc "We really aren't."
            mc "I'm sorry if it looked like that."
            mo 1c "Ahaha, I'm just asking."
            mo "She sure seems to enjoy your company though."
            mo 1b "You must be a good friend."
            mc "I try my best."
            show natsuki 1ba zorder 3 at f21
            show momsuki zorder 2 at t22
            n "Here, I've got the paper."
            n "Sorry it took so long."
            show natsuki zorder 2 at t21
            show momsuki 1b zorder 3 at f22
            mo "It's no problem at all!"
            mo 1c "[player], perhaps you should go upstairs?"
            mo 1a "I know you don't have any ill intent but it's just a precaution."
            show momsuki zorder 2 at t22
            mc "Uh...sure."
            mc "I'll just start cleaning some of the rooms upstairs then."
            show momsuki 1c zorder 3 at f22
            mo "Great idea."
            mo "I haven't made a start on the bedroom yet."
            mo 1b "So there's probably a lot of things you could do there."
            show momsuki zorder 2 at t22
            mc "Alright, I'll get on it."
            show natsuki 5be zorder 3 at f21
            n "You better not do anything weird!"
            show natsuki zorder 2 at t21
            mc "Eh? I wouldn't dare."
            mc "I'm just here to clean after all."
            show natsuki 5by
            "Natsuki looks at me and nods her head."
            mc "I'll see you in a couple of minutes, Natsuki."
            scene bg n_dadroom with wipeleft_scene
            "I go into the room Haruki told me to go."
            "For some reason, I knew exactly where to go."
            "Like I'm familiar with Natsuki's house."
            "I've been here a couple of times but..."
            "I didn't even need to guess which room was the bedroom."
            "I'm probably overthinking things."
            mc "Where to start?"
            "The room has a lot of dirt just lying around."
            "It's hard to believe someone used to sleep in here."
            "I should probably get the dirt from under the bed first."
            "After a couple of minutes, I manage to clear an area of dirt to move the bed to."
            "Before I can start clearing the mess under the bed..."
            "I notice something really strange on the ground."
            "It isn't dirt but more like...markings?"
            mc "What is this?"
            "The markings are kinda nonsensical."
            "There's some sort of tally or...something."
            stop music fadeout 3.0
            "That's nothing compared to the thing that stands out the most."
            "There's an image of a stopwatch on top of some sort of rectangular disk."
            "It's those things that used to be used on old computers before CDs and DVDs."
            "Still...why is this here?"
            "Maybe they wanted to keep this a secret?"
            "Should I tell Natsuki?"
            "Does she already know about this?"
            "I've been staring at it for a few minutes now."
            "It's hard to take my eyes off it..."
            show momsuki 1a zorder 2 at t11
            mo "Hmm...are you okay?"
            mc "H-Huh?!"
            "I drop the broom."
            mo 1d "Oh, sorry."
            "I'm caught by surprise by Haruki."
            mo "I didn't mean to scare you like that."
            mo "I'll try to warn you next time."
            mc "Haruki..."
            mo 1a "[player]?"
            mc "I-I don't meant to pry..."
            mc "But there's something I'm wondering."
            "Haruki simply looks at me."
            mc "What is that?"
            "I point towards the area underneath where the bed was."
            mo "That?"
            mo 1c "Oh, nothing important."
            mo "Just forget you saw anything, [player]."
            "The tone of Haruki's voice is kind of intimidating."
            mo 1a "Go to Natsuki's room and speak with her."
            mo "She has the recipe already."
            if persistent.markov_agreed:
                ...
                n 1bk "Oh, you're finally ready."
                "Natsuki puts away the recipe."
            else:
                "Suddenly, I start feeling incredibly dizzy."
                mc "What the hell is going on?"
                mo 1e "Nothing."
                mo 1i "Just do as I say."
                mc "W-What {i}are{/i} you?{nw}"
                $ _history_list = []
                show screen tear(20, 0.1, 0.1, 0, 40)
                window hide(None)
                play sound "sfx/s_kill_glitch1.ogg"
            ...
            mc "Why is that?"
            n 1ba "It's so I can get them easier."
            n "That way, I don't have to go into their room just to find something to read."
            mc "That makes sense."
            ...
            mc "It is?"
            mc "I swear it doesn't feel like I've been here long."
            n "It doesn't?"
            n "You know it took a decent amount of time to write the recipe down."
            n "You were upstairs for a long time."
            mc "Wait...I was?"
            n "Are you messing with me?"
            mc "No...it's just..."
            mc "N-Never mind."
            ...
            "Just how long was I in that room for...?"
            n "Thanks for coming, [player]."
...
>>>>>>> upstream/master
        ...
        if n_appeal >= 4 and n_appealS >= 1:
            ...
            mc "Maybe a big cake and some cupcakes?"
            n 1bc "That could work."
            n "I don't really have much experience baking big cakes."
            ...
            show dadsuki zorder 2 at t21
            "There's a silence as Yasuhiro says that."
            "They both know it's right."
            "To an extent, I believe Yasuhiro as well."
            "With all that Natsuki has gone through..."
            "Seeing her live a normal life after all of that seems unlikely."
            "But still..."
            mc "But you can try, can't you?"
            mc "Both of you can."
            mc "You're both trying to change too much because of what's happened."
            ...
            mc "It seems like a lot of books to just keep on your desk."
            n 1be "Obviously!"
            n "I asked my dad if I could get a bookshelf or something."
            n "He didn't really say no so I assume I'm getting one."
            n "For now, he said I could move all the books I wanted to read here."
            mc "Why is that?"
            n 1ba "It's so I can get them easier."
            n "That way, I don't have to go into their room just to find something to read."
            mc "That makes sense."
            ...
            "It's not done up or anything so I don't think he'll notice."
            ...
            mc "No, really."
            mc "Take a look."
            n "Later, I'm still looking for some books."
            "I get off the bed and move to get a better look."
            "I see tally marks."
            "At least, that's what they look like."
            "But there's something else."
            "Something that looks almost unnatural."
            "I think it's some sort of sword?"
            "Or an arrow of some kind."
            "It's kind of hard to see without much light."
            "It's incredibly detailed too which is strange..."
            "Since it's carved on a wooden floor."
            mc "Natsuki?"
            "I feel...slow for some reason."
            "[player]."
            "Like everything around me is just going faster."
            "[player]..."
            ...
            d "I need to speak to you outside."
            ...
            mc "I'll see you at the club, Natsuki."
            "I wave goodbye to Natsuki before heading home."
            scene bg bedroom with wipeleft_scene
            play music t2 fadeout 0.5
            "I arrive home, thinking about how Natsuki must be feeling."
            "She lives with her father now but they're clearly still estranged."
            "She's acting by herself for the most part but..."
            "I wonder how she's really feeling about this?"
            "Is she happy her dad is back, deep inside?"
            "Or is she reluctant to accept him because she thinks she'll get hurt again?"
            "I get my bag and take out the four books I took from Natsuki's house and place them on my desk."
            "What exactly was that under the bed?"
            "I wish I got a better look."
            "And why did I lie to her?"
            "All these thoughts are just stuck in my head."
            "I should stop thinking about it so much."
            "I still have a poem to write after all..."
    else:
        ...
        n "Whatever..."
        n "This place is giving me a really bad feeling."
        mc "Yeah, you're not wrong."
        mc "Maybe it's haunted."
        n "Don't say that!"
        n "It's not helping at all!"
        n "Let's just go back to my room."
        n "I don't think I can stay in here any longer."
        mc "Are you sure you don't want to finish cleaning it?"
        n "After seeing that?"
        n "I'm not in the mood anymore."
        mc "I'm sorry."
        n "What for?"
        n "You didn't do anything."
        mc "I showed you that."
        n "I would have found out sooner or later."
        ...
        "Are those from Yasuhiro's room?"
        mc "What are those for?"
        n "We have to choose some books, don't we?"
        n "I got these just before you came."
        n "I was gonna look through them all to see what I wanted to bring."
        mc "I see."
        n "There's a lot of manga here."
        n "I'm sure you'll find a couple that you like."
        mc "Do you have somewhere you're going to put all of these?"
        mc "It seems like a lot of books to just keep on your desk."
        n 1bc "N-Not really..."
        n "I was going to move the bookshelf in Yasuhiro's room but..."
        n "I don't know anymore."
        n "Maybe I'll just get a bookshelf or something..."
        n "But for now I moved all the books I'm interested in here."
        mc "Yeah...I can see why."
        "Natsuki looks through the books on the desk."
        n 2bc "I already know the books I'm going to choose."
        n "Do you?"
        ...
        play music t2 fadeout 0.5
        "I arrive home, thinking about how Natsuki must be feeling."
        "She lives alone now...no mother or father to guide her."
        "I guess her life is her own now but..."
        "I wonder how she's really feeling about this?"
        "Is what I'm seeing just what she wants me to see...?"
        "I get my bag and take out the four books I took from Natsuki's house and place them on my desk."
        "What was that we found in the room?"
        "It's just lingering in my head."
        "I should stop thinking about it so much."
        "I still have a poem to write after all..."
    return
...
label ch13_natsuki_outcomeshared_date:
    ...
    n "[player] suggested that we should get some more supplies for our preparations while we're in the city."
...
label ch13_natsukidate:
    ...
    if ch4_name == "Natsuki":
        ...
        mc "I could feel something between us."
    else:
        mc "Well..."
    ...
    mc "It's just not who I am."
    mc "I can't take hints very well."
    ...
    if ch12_outcome == 3:
        ...
        mc "I would have thought you would have known them better than me."
    else:
        mc "He's your dad..."
        mc "I don't know him very well."
    ...
    if ch12_outcome == 3:
        ...
        n "How do you think my dad is going to react to that?"
    mc "I don't know."
    ...
    mc "I sure hope this goes well..."
    mc "I know it was my idea but I honestly have no idea how this is going to turn out."
    mc "..."
    ...
    if ch12_outcome == 3:
        ...
        mc "So what do we do?"
        mc "They aren't here."
        mc "And we have no idea where they are."
    else:
        "Yasuhiro isn't anywhere in sight."
    ...
    menu:
        ...
        "Take two manga and two novels.":
            ...
            mc "So really I just chose three backups and a manga."
            n 1bk "Well, it's up to you."
            "Natsuki simply shrugs."
            n "Not like I can make you change your mind or anything."
            "I look through the pile to find another novel I think is popular."
    "I put the books I chose into my bag."
    "Natsuki puts the manga she took in her bag."
    n 1bc "Anyway...it's getting kinda late."
    mc "Yeah, it is."
    ...
    "She suddenly gets closer to me."
    mc "Wait, Natsuki--"
    ...
    n 1bh "Spending today..."
    n "With you..."
    n 1bo "It's been--!!"
    show natsuki zorder 2 at t11
    n "Y-Your phone..."
    n "It's ringing, [player]."
    mc "Ah..."
    "Incredible timing."
    ...
    mc "Huh? How did you--"
    s "I'm just calling to say that it's okay you didn't get much done."
    s "It's better that you enjoyed yourself."
    s "You and Natsuki both."
    mc "Thanks?"
    s "How is she anyway?"
    ...
    mc "Alright, Sayori."
    s "Anyway, I'll be going now."
    s "Got lots of stuff to do."
    ...
    scene bg bedroom with wipeleft_scene
    play music t2 fadeout 0.5
    "I arrive home, with the paper Natsuki gave me in my hand."
    "I place the four books I got from Natsuki on my desk."
    "I open the paper without properly looking at it."
    "I'm kinda anxious to read it."
    "I can probably guess what it is but still..."
    "Here goes..."
    call showpoem (poem_n8, music=False)
    "I had a feeling it would be a poem."
    "From what I can tell, it kinda feels like she doesn't care much for her life."
    "At least, not until she's with me."
    "That's just my interpretation though."
    "I'm not certain that's how she meant it."
    "Whatever it was meant to be, it's still a good poem."
    "I can't wait to meet up with her again tomorrow."
    "We'll not only spend more time together but also get to do some actual preparations."
    "I hope it all goes well."
    "I wonder what Natsuki is doing right now."
    if ch12_outcome == 3:
        "She texted me that her parents finally got home after a couple of hours."
        "Apparently they were inspired by us going on a date..."
        "So they went on a date themselves."
        "Good for them on trying to bring things back to normal, I guess."
    else:
        "She texted me that Yasuhiro finally got home after a couple of hours."
        "Apparently he got some supplies for baking."
        "He got a lot of random stuff that Natsuki didn't need."
        "I think she still appreciates it though."
    "Anyway, I still have some things to do."
    "Like write a poem for tomorrow..."
